...
public class WebController {
    ...
    */
    ...
    public String heatmap(Model model){
        ...
        registros.add(new Registro("amanecer",1,"21-11-19","01:00",54.0,25.0));
        registros.add(new Registro("amanecer",1,"21-11-19","02:00",13.0,23.0));
        registros.add(new Registro("amanecer",1,"22-11-19","00:00",78.0,14.0));
        registros.add(new Registro("amanecer",1,"22-11-19","01:00",67.0,26.0));
        registros.add(new Registro("amanecer",1,"22-11-19","02:00",49.0,43.0));
